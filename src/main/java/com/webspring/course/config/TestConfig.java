...
import com.webspring.course.entities.*;
import com.webspring.course.entities.enum_class.OrderStatus;
import com.webspring.course.repositories.*;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {//metódo que roda no instant run do program
        ...
        User u4 = new User(null, "Joana", "joanamaria@gmail.com","989124573","13456poiu");

        Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"), OrderStatus.PAID, u1);
        Order o2 = new Order(null, Instant.parse("2019-07-21T03:42:10Z"),OrderStatus.WAITING_PAYMENT, u2);
        Order o3 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"),OrderStatus.WAITING_PAYMENT, u1);
        Order o4 = new Order(null, Instant.parse("2024-02-18T15:21:22Z"),OrderStatus.PAID, u3);
